      ...
      integer(int64), parameter :: mi=64
      integer(int64), parameter :: mj=64
      integer(int64), parameter :: mk=64
	  integer(int64), parameter :: mkm2=mk-2
	  integer(int64), parameter :: mtot=mi*mj*mk
	  integer(int64), parameter :: Temp=0.05
      integer(int64), parameter :: nsteps=10000
	  integer(int64) :: qq(mi,mj,mk) ! chirality
	  integer(int64) :: dope(mi,mj,mk) ! dopant mask
	  integer(int64) ::  kount(mk) ! for measuring density of spins in each z-slice
	  integer :: nconfigs
	  real(real64) :: nx(mi,mj,mk),ny(mi,mj,mk)
	  real(real64) :: nz(mi,mj,mk)
	  real(real64) :: crossx,crossy,crossz,dott
	  real(real64) :: nnx,nny,nnz
	  real(real64) :: d,KK,phitop,rho,pi,twopi
	  real(real64) :: rhoz(mk)
      integer(int64) :: ndope
